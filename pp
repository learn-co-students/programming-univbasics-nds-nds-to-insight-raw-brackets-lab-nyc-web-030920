...
{:name=>"Stephen Spielberg",                  #hash 0 
 ...
 {:name=>"Russo Brothers", :movies=>
   [
    ...
    {:title=>"Captain America The Winter Soldier", :studio=>"Buena Vista", :worldwide_gross=>259766572, :release_year=>2014},
 ...
 {:name=>"James Cameron",
  :movies=>
   [
    {:title=>"Avatar", :studio=>"Fox", :worldwide_gross=>760507625, :release_year=>2009},
    {:title=>"Titanic", :studio=>"Paramout", :worldwide_gross=>659363944, :release_year=>1997},
    {:title=>"Titanic", :studio=>"Paramout", :worldwide_gross=>659363944, :release_year=>1997},
    {:title=>"Terminator 2 Judgment Day", :studio=>"TriStar", :worldwide_gross=>205881154, :release_year=>1991},
    {:title=>"True Lies", :studio=>"Fox", :worldwide_gross=>146282411, :release_year=>1994},
    {:title=>"Aliens", :studio=>"Fox", :worldwide_gross=>85160248, :release_year=>1986},
    {:title=>"The Abyss", :studio=>"Fox", :worldwide_gross=>54461047, :release_year=>1989}]},
    
 {:name=>"Spike Lee",
  :movies=>
   [
    {:title=>"Inside Man", :studio=>"Universal", :worldwide_gross=>88513495, :release_year=>2006},
    {:title=>"BlacKkKlansman", :studio=>"Focus", :worldwide_gross=>49275340, :release_year=>2018},
    {:title=>"Malcolm X", :studio=>"Warner Brothers", :worldwide_gross=>48169910, :release_year=>1992},
    {:title=>"The Original Kings of Comedy", :studio=>"Paramount", :worldwide_gross=>38182790, :release_year=>2000},
    {:title=>"Jungle Fever", :studio=>"Universal", :worldwide_gross=>32482682, :release_year=>1991}]},
